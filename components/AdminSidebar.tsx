...
const navItems = [
  ...
  { href: "/admin/abandoned", label: "Abandoned", icon: "funnel" },
  { href: "/admin/venues", label: "Olympic Venues", icon: "map" },
  ...
  return (
    <aside className="fixed left-0 top-0 z-40 flex h-screen w-60 flex-col border-r border-gray-100 bg-white">
      ...
      <div className="flex items-center gap-2.5 border-b border-gray-100 px-6 py-5">
        <div className="flex h-8 w-8 items-center justify-center rounded-lg bg-[#4C6C4E]">
      ...
      <div className="border-t border-gray-100 p-3">
        <button
          ...
          className="flex w-full items-center gap-3 rounded-lg px-3 py-2.5 text-[13px] font-medium text-gray-500 transition-colors hover:bg-gray-50 hover:text-gray-700"
        >
