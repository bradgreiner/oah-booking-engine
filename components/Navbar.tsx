  ...
  const searchFields = (
    <div className="space-y-3">
      ...
      <button
        ...
        className="w-full rounded-lg bg-[#4C6C4E] py-2.5 text-sm font-medium text-white transition hover:bg-[#3d5a40] disabled:opacity-70 disabled:cursor-not-allowed"
      >
        {isSearching ? (
